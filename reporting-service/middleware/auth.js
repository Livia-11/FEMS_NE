/**
 * Authentication and authorisation middleware for the reporting-service.
 *
 ...
 *
 * Usage:
 *   router.get('/reports/dashboard', authenticate, handler)
 *   router.get('/reports/export',    authenticate, authorize('admin', 'inspector'), handler)
 */
 ...
 * @example router.get('/export', authenticate, authorize('admin', 'inspector'), handler)
 */
